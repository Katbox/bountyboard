...
Bounty.create(:id => 1, :user_id => 1, :accept_id => 3, :name => 'Bounty1', :desc => 'This is bounty 1.', :url => 'www.1.com', :price => 10.00)

#Bounty 2, Created by Devin, Accepted by Artist1.
Bounty.create(:id => 2, :user_id => 1, :accept_id => 3, :name => 'Bounty2', :desc => 'This is bounty 2.', :url => 'www.2.com', :price => 15.00)

#Bounty 3, Created by Devin, Rejected by Artist1.
Bounty.create(:id => 3, :user_id => 1, :reject_id => 3, :name => 'Bounty3', :desc => 'This is bounty 3.', :url => 'www.3.com', :price => 20.00)

#Bounty 4, Created by Devin, Accepted by Artist2. Completed by Artist2.
Bounty.create(:id => 4, :user_id => 1, :accept_id => 4, :complete_id => 4, :name => 'Bounty4', :desc => 'This is bounty 4.', :url => 'www.4.com', :price => 25.00)
